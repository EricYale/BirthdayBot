...
<html>
    <body>
        ...
        <p>
            Have a great day,<br>
            The
            <a href="https://github.com/EricYale/BirthdayBot" style="color: inherit;">Yale Birthday Bot</a>
        </p>
        ...
        <footer style="color: #777777; font-size: 8pt; margin-top: 20px;">
            ...
            Gemini is responsible for the contents of this poem. Like what you see? Something not in good taste? Reply to this email with your feedback.
        </footer>
    </body>
</html>
`;
